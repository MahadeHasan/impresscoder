...
final class Google_Fonts{
    ...
    public static function default_font_families(){
        return [ 
            'body_font_family' => [                
                'family_id' => 'sourcesanspro',
                'family' => 'Source Sans Pro',
                'variants' => ['400', '300', '600', '700', '800'],
    ...
    public static function font_family_options(){
        $families        = array(
            '' => esc_attr__('Inherit', 'impresscoder')
        );
		$google_fonts = get_option( 'impresscoder_google_fonts', array() );
    ...
    static function get_google_fonts_url() {
        ...
        $GLOBALS['impresscoder_fonts'] = $set_google_fonts;

        global $google_fonts;
		
		$families            = array(
            'sourcesanspro' =>  'Source+Sans+Pro:300,400,500,600,700,800'
        );
		$subsets             = array();
		$append              = '';
    ...
    static function fetch_google_fonts( $normalize = true, $force_rebuild = false ) {
        ...
        $google_fonts_cache_key = apply_filters( 'impresscoder_google_fonts_cache_key', 'impresscoder_google_fonts_cache' );
    
        // Get the fonts from cache.
        $google_fonts = apply_filters( 'impresscoder_google_fonts_cache', get_transient( $google_fonts_cache_key ) );
        ...
        if ( $force_rebuild || ! is_array( $google_fonts ) || empty( $google_fonts ) ) {
            ...
            // API url and key.
            $google_fonts_api_url = apply_filters( 'impresscoder_google_fonts_api_url', 'https://www.googleapis.com/webfonts/v1/webfonts' );
            $google_fonts_api_key = apply_filters( 'impresscoder_google_fonts_api_key', 'AIzaSyAY4CxRw0I0VvaABZcMcNqU-Zjuw7xjrW4' );
            ...
            $google_fonts_fields = apply_filters(
                'impresscoder_google_fonts_fields',
                array(
                    'family',
                    'variants',
                    'subsets',
            ...
            $google_fonts_sort   = apply_filters( 'impresscoder_google_fonts_sort', 'alpha' );
            ...
            if ( 200 === wp_remote_retrieve_response_code( $google_fonts_response ) ) {
                ...
                if ( $response_body ) {
                    ...
                    if ( is_array( $google_fonts_data ) && isset( $google_fonts_data['items'] ) ) {
                        ...
                        update_option( 'impresscoder_google_fonts', $google_fonts );
