...
class Comment_Walker extends \Walker_Comment {
	...
	protected function html5_comment( $comment, $depth, $args ) {
		...
		if ( $commenter['comment_author_email'] ) {
			$moderation_note = esc_attr__( 'Your comment is awaiting moderation.', 'impresscoder' );
		} else {
			$moderation_note = esc_attr__( 'Your comment is awaiting moderation. This is a preview; your comment will be visible after it has been approved.', 'impresscoder' );
		}
		?>
				...
				<!-- <div class="w-100"> -->
					<div class="comment-meta d-lg-flex align-items-start gap-10 mb-10">
						...
						<div class="comment-metadata d-grid">
							...
							printf(
								...
								sprintf(
									...
									esc_attr__( '%1$s at %2$s', 'impresscoder' ),
						...
						<div class="ms-lg-auto d-flex gap-15">
							<?php                  
							$edit_text = __( 'Edit', 'impresscoder' );
