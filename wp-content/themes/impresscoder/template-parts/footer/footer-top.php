...
<div class="footer-top-section py-30">
    <div class="container d-flex flex-wrap align-items-center justify-content-lg-between">
        ...
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="footer-logo align-items-center">
          <img src="<?php echo esc_url(impresscoder_theme_mod_image_uri('footer_logo', 'assets/images/logo-white.png' )); ?>" width="150" alt="<?php echo esc_attr(get_bloginfo( 'name', 'display' )) ?>">
        </a>
        <?php endif; ?>
        <?php
            if(has_nav_menu('footer_social')):
                ...
                printf('<span class="footer-social-nav-title fs-3">'.esc_attr_x('%s', 'Footer social nav title', 'impresscoder').'</span>', get_theme_mod('footer_social_nav_title', esc_attr__('Follow Us On:', 'impresscoder')));
                wp_nav_menu(
                    array(                        
                        'container'      => false,
                        ...
                        'fallback_title'    => esc_attr__('Footer social menu', 'impresscoder'),
